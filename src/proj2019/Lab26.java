...
//		ArrayList<ArrayList<card>> cardpairs = new ArrayList<ArrayList<card>>();
		...
		System.out.println("第一位玩家的手牌");traversal(p1);
		System.out.println("玩家將手牌排序後:");
		traversal(InsertionSort(p1));
		System.out.print("第一位玩家的");findpairs(InsertionSort(p1));
		System.out.println("第二位玩家的手牌");traversal(p2);
		System.out.println("玩家將手牌排序後:");
		traversal(InsertionSort(p2));
		System.out.print("第二位玩家的");findpairs(InsertionSort(p2));
		System.out.println("第三位玩家的手牌");traversal(p3);
		System.out.println("玩家將手牌排序後:");
		traversal(InsertionSort(p3));
		System.out.print("第三位玩家的");findpairs(InsertionSort(p3));
		System.out.println("第四位玩家的手牌");traversal(p4);
		System.out.println("玩家將手牌排序後:");
		traversal(InsertionSort(p4));
		System.out.print("第四位玩家的");findpairs(InsertionSort(p4));
	}
